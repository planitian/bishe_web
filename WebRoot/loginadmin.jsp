...
<body>
	<div class="login">
		<div class="dianji">
			...
			<p>
				<a href="index.jsp">员工登陆</a>
			</p>
			<p style="color: #b3b3b3; ">管理员登陆</p>

		</div>

		<form action="loginAdmin.action" method="post" onSubmit="return yan();" name="shuju" >
				...
				<div class="input">
					...
					<div class="log">
						...
						<div class="name"><table><tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td> <s:actionerror cssStyle="color:red"/></td></tr></table></div>
								...
								placeholder="请输入管理员账号" name="username" tabindex="1"
